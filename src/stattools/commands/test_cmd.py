"""
stattools.commands.test_cmd — the ``dfstat test`` subcommand.
...
Example
-------
    dfstat test data.tsv -c col1:col2 -d pvalue --test student_t
    dfstat test data.tsv -c a:b c:d -d p_ab p_cd -g group --test mannwhitneyu
    dfstat test boot.tsv -c s1:s2 -d p --test bootstrap --randomseed 42
"""
