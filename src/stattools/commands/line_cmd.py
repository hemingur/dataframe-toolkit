"""
stattools.commands.line_cmd — dfstat line subcommand.
...
Basic line plot:
  ...
  dfstat line data.tsv -x time -y value

Multiple lines by group:

  dfstat line data.tsv -x time -y value -g group

Symmetric error bars:

  dfstat line data.tsv -x time -y mean --yerr stderr

Asymmetric confidence intervals:

  dfstat line data.tsv -x time -y mean --yci cilo,cihi

Subplot grid by condition:

  dfstat line data.tsv -x time -y value --subgraphcol condition -g group

Staircase / step plot:

  dfstat line data.tsv -x time -y value --drawstyle steps-mid

Fit and overlay regression line:

  dfstat line data.tsv -x time -y value --fit

Publication figure (Nature double column, PDF):

  dfstat line data.tsv -x time -y value --size double --fontsize publication -f fig.pdf
"""
