"""
stattools.commands.sample_cmd — dfstat sample subcommand.
...
Examples
--------
    dfstat sample data.tsv -n 100
    dfstat sample data.tsv -f 0.8
    dfstat sample data.tsv -n 50 -g treatment --randomseed 42
    dfstat sample data.tsv -f 1.0 --randomseed shuffle
"""
...
--------
  ...
  dfstat sample data.tsv -f 0.8
  dfstat sample data.tsv -n 50 -g treatment --randomseed 42
  dfstat sample data.tsv -f 1.0 --randomseed shuffle   # reproducible shuffle
  dfstat sample data.tsv -n 10 -g group --replace
"""
