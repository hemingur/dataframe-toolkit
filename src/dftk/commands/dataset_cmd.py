"""
dftk.commands.dataset_cmd — the ``dftk dataset`` subcommand.
...
into the dftk parquet pipe with -o.

Examples
--------
    dftk dataset iris
    dftk dataset iris --source seaborn
    dftk dataset longley --source statsmodels
    dftk dataset --list
    dftk dataset --list --source seaborn
    dftk dataset iris -o | dftk stat -c sepal_length -g species
"""
