"""
dftk.commands.randvar_cmd — dftk randvar subcommand.
...
-----
  ...
  dftk randvar -n 500  -d x --dist beta --parameters a:2,b:5 --randomseed 42
...
--------
  ...
  dftk randvar --list
  dftk randvar --list | dftk query - --query "type == 'continuous'"
"""
